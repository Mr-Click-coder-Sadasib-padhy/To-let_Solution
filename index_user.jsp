        ...
        <div class="nav container">
            ...
            <ul class="navbar">
                ...
                <li><a href="#properties">Properties</a></li>
                 <li><a href="#properties">Welcome <%=name %> </a></li>
            </ul>
            <!-- Log In Button -->
...
<!-- Home -->
    <section class="home container" id="home">
        <div class="home-text">
            ...
            <a href="Register_page.html" class="btn">Sign Up</a>
        </div>
    </section>
    <!-- About -->
    ...
    <section class="sales container" id="sales">
        ...
        <div class="box">
            ...
            <h3><a href="Membership_Payment_gateway.html">Start Your Membership!!</a></h3>
            <p>Prime User Can only add the property..</p>
        </div>
        <!-- Box 1 -->
        <div class="box">
